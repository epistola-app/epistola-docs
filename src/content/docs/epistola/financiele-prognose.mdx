...
- Deze simulatie modelleert de **geborgde** situatie via de licentie (antwoord 2 op de [kernvraag](/epistola/modelkeuze)). De andere borging — een [GIBIT-onderhoudsbijdrage](/epistola/modelkeuze#aanbeveling-aan-de-vng-pas-de-gibit-aan) (antwoord 1) — levert een vergelijkbare inkomstenbasis maar is hier niet apart doorgerekend

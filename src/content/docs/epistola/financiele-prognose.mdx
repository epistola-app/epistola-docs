...
De stichting neemt in principe geen mensen aan — ze besteedt het ontwikkelwerk uit aan Epistola BV onder cost-plus pricing. Wat de BV kost om te draaien, factureert ze terug aan de stichting als onderhoudsbudget.
...
flowchart LR
    ...
    S["🏛️ Stichting"]
    BV["🏢 Epistola BV"]
    SAAS["☁️ SaaS-aanbieders"]
    PS["🏢 Preferred suppliers"]

    G -->|"Licentie (vast tarief per inwonertal)"| S
    SAAS -->|"Per-document afdracht"| S
    PS -->|"Certificeringsbijdrage (jaarlijks)"| S
    S -->|"Onderhoudsbudget (cost-plus)"| BV
    S -->|"Administratie + stewards-vergoedingen"| S
...
De simulatie modelleert de stichting en de BV als aparte cash-flows. De BV is structureel break-even (cost-plus). De interessante dynamiek zit aan de stichting-kant: dekken de externe inkomsten het BV-onderhoudsbudget plus de admin-overhead?

...
De stichting heeft zelf geen personeel. Voor het ontwikkel- en onderhoudswerk van het platform besteedt ze uit — onder cost-plus pricing — aan één of meer leveranciers. Epistola BV is dan de meest voor de hand liggende partij vanwege diepe platformkennis, maar de stichting kan dat werk ook (deels) bij andere preferred suppliers beleggen. Voor de BV is platform-onderhoud daarmee één inkomstenbron naast haar dienstverlening aan gemeenten, geen vanzelfsprekendheid.
...
flowchart LR
    ...
    PS -->|"Licentie-afdracht + certificering"| S
    SAAS -->|"Per-document afdracht + certificering"| S

...
**Praktijkvoorbeelden:**
- Gemeente 10k inwoners: **€1.800/jaar** licentie
- Gemeente 50k inwoners: **€4.500/jaar** licentie
- Gemeente 150k inwoners: **€10.000/jaar** licentie
...
|---|---|---|
| **Licentie** | Stichting | €800–€20.000 (afhankelijk gemeente) |
...
**Meer informatie:** Zie [Voor Gemeenten — Overzicht](/meedoen/gemeenten/overzicht) voor de SLA-keuzecalculator en details per niveau.
...
**Lees meer:** [Modelkeuze & Transitiestrategie](/epistola/modelkeuze) legt uit waarom vendor lock-in zo schadelijk is en hoe Epistola dit structureel oplost.
...
1. **Vraag offerte aan [preferred supplier](/meedoen/leveranciers/overzicht)**
...
**Nuttige links:**
- [Model 2: BSL + Ecosysteem](/epistola/model-2-bsl-licentie) - Volledige prijstabel en schaalvoordelen
- [Aanbestedingen](/meedoen/gemeenten/aanbestedingen) - Hoe Epistola past in aanbestedingen
- [Epistola Organisatiestructuur](/epistola/organisatiestructuur) - Hoe het model werkt

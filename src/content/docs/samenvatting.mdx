...
Het concrete voorbeeld: stichting + BV, vijf statutaire constraints (max salaris, geen winstuitkering, overwinst terug, 100% focus, max 20 FTE), de twee verdienmodellen doorgerekend, plus centrale aanbesteding.
...
- [Centrale aanbesteding](/epistola/model-3-centraal-aanbesteed) — Risico: monopsonie
